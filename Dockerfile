...
RUN curl -L --retry 3 --output "/usr/share/graylog/plugin/graylog-plugin-auth-sso-2.5.0.jar" \
"https://github.com/Graylog2/graylog-plugin-auth-sso/releases/download/2.5.0/graylog-plugin-auth-sso-2.5.0.jar"
